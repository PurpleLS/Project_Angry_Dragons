...
Graphics::Graphics()
{
	...
	m_pictures[4].loadFromFile("Pictures/dragon1_icon.png");
	m_pictures[5].loadFromFile("Pictures/dragon2_icon.png"); // rhaegal
	m_pictures[6].loadFromFile("Pictures/dragon3_icon.png"); // viserion
	m_pictures[7].loadFromFile("Pictures/ground_icon.png"); // ground
}
